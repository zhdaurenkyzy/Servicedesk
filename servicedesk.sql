CREATE SCHEMA `servicedesk` DEFAULT CHARACTER SET utf8 ;
...
CREATE TABLE `language` (
  ...
  `LANGUAGE_LOCAL` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
INSERT INTO `servicedesk`.`user` (`USER_NAME`, `USER_MAIL`, `USER_LOGIN`, `USER_PASSWORD`, `USER_ROLE`) VALUES ('Клиент', 'client@gmail.com', 'client', '62608e08adc29a8d6dbc9754e659f125', '2');
INSERT INTO `servicedesk`.`user` (`USER_NAME`, `USER_MAIL`, `USER_LOGIN`, `USER_PASSWORD`, `USER_ROLE`) VALUES ('Инженер', 'engineer@gmail.com', 'engineer', '9d127ff383d595262c67036f50493133', '1');
INSERT INTO `servicedesk`.`user` (`USER_NAME`, `USER_POSITION`, `USER_PHONE`, `USER_MOBILE`, `USER_MAIL`, `USER_LOGIN`, `USER_PASSWORD`, `USER_ROLE`) VALUES ('Admin', 'Administrator', '87079630000', '+7(777)7777777', 'admin@gmail.com', 'admin', 'e00cf25ad42683b3df678c61f42c6bda', '0');
INSERT INTO `servicedesk`.`user` (`USER_NAME`, `USER_MAIL`, `USER_LOGIN`, `USER_PASSWORD`, `USER_ROLE`) VALUES ('Engineer2', 'engineer2@gmail.com', 'engineer2', '48959795e9762677fa062985f1e3b9e6', '1');
INSERT INTO `servicedesk`.`user` (`USER_NAME`, `USER_MAIL`, `USER_LOGIN`, `USER_PASSWORD`, `USER_ROLE`) VALUES ('Engineer3', 'engineer3@gmail.com', 'engineer3', '2b3cc30fac25aa7670df0e10c2372c6e', '1');
INSERT INTO `servicedesk`.`user` (`USER_NAME`, `USER_MAIL`, `USER_LOGIN`, `USER_PASSWORD`, `USER_ROLE`) VALUES ('Client2', 'client2@gmail.com', 'client2', '2c66045d4e4a90814ce9280272e510ec', '2');
INSERT INTO `servicedesk`.`user` (`USER_NAME`, `USER_MAIL`, `USER_LOGIN`, `USER_PASSWORD`, `USER_ROLE`) VALUES ('Client3', 'client3@gmail.com', 'client3', 'c27af3f6460eb10979adb366fc7f6856', '2');
INSERT INTO `servicedesk`.`user` (`USER_NAME`, `USER_MAIL`, `USER_LOGIN`, `USER_PASSWORD`, `USER_ROLE`) VALUES ('Operator', 'operator@gmail.com', 'operator', '4b583376b2767b923c3e1da60d10de59', '0');

INSERT INTO `servicedesk`.`engineer_group` (`GROUP_NAME`) VALUES ('System admin');
...
INSERT INTO `servicedesk`.`language` (`LANGUAGE_NAME`, `LANGUAGE_LOCAL`) VALUES ('en', 'EN');
INSERT INTO `servicedesk`.`language` (`LANGUAGE_NAME`, `LANGUAGE_LOCAL`) VALUES ('ru', 'RU');

INSERT INTO `servicedesk`.`level` (`LEVEL_NAME`) VALUES ('Service request');
INSERT INTO `servicedesk`.`level` (`LEVEL_NAME`) VALUES ('Change request');
INSERT INTO `servicedesk`.`level` (`LEVEL_NAME`) VALUES ('Incident');

INSERT INTO `servicedesk`.`mode` (`MODE_NAME`) VALUES ('Phone');
INSERT INTO `servicedesk`.`mode` (`MODE_NAME`) VALUES ('Mail');
INSERT INTO `servicedesk`.`mode` (`MODE_NAME`) VALUES ('Monitoring');
INSERT INTO `servicedesk`.`mode` (`MODE_NAME`) VALUES ('Web Form');

INSERT INTO `servicedesk`.`project` (`PROJECT_NAME`, `PROJECT_STATE`) VALUES ('Demeu Company', '1');
...
INSERT INTO `servicedesk`.`status` (`STATUS_NAME`) VALUES ('Open');
