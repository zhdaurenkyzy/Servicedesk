...
<html>
	...
	<body>
		...
		<div class="header">
                 ...
                 <input id="idField" type="hidden" name="page" value ="modeCabinet?modeID=${modeID}">
    ...
    <form method="POST" action="/updateMode">
        <p><fmt:message key = "key.mode" bundle = "${resourceBundle}"/>: <input id="nameField" type="text" name="name" required value = <c:out value="${mode.getName()}"/>></p>
        <p><input id="idField" type="hidden" name="id" value = <c:out value="${mode.getId()}"/>></p>
    ...
    <p> <input id="modeField" type="hidden" name="id" value = <c:out value="${mode.getId()}"/>></p>
